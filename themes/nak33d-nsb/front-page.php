...
<div class="view view-first">  
   <img src="http://dev.nsbequipment.com/wp-content/uploads/2015/07/tandoori2.png" />  
     <div class="mask">  
     <h2>Coming Soon!!</h2>  
    <!-- <p>Your Text</p>  -->
         <a href="/equipment" class="info">Buy Online</a>  
     </div>  
</div>
    </li>
	<li>
<div class="view view-first">  
  <img src="http://dev.nsbequipment.com/wp-content/uploads/2015/07/CHB-704BoosterSeat.jpg" />  
     <div class="mask">  
     <h2>Coming Soon!!</h2>  
    <!-- <p>Your Text</p>  -->
         <a href="/equipment" class="info">Buy Online</a>  
	...
	<li>
<div class="view view-first">  
  <img src="http://dev.nsbequipment.com/wp-content/uploads/2015/07/range.png" />  
     <div class="mask">  
     <h2>Coming Soon!!</h2>  
    <!-- <p>Your Text</p>  -->
         <a href="/equipment" class="info">Buy Online</a>  
	...
	<li>
<div class="view view-first">  
  <img src="http://dev.nsbequipment.com/wp-content/uploads/2015/07/knives.png" />  
     <div class="mask">  
     <h2>Coming Soon!!</h2>  
    <!-- <p>Your Text</p>  -->
         <a href="/equipment" class="info">Buy Online</a>  
