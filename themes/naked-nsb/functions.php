...
register_nav_menus( 
	array(
		...
		'hdr-home'	=>	__( 'Home Header Menu', 'naked' ), // Register the Header menu
...
function naked_scripts()  { 
	...
	wp_enqueue_script( 'naked-scroll', get_template_directory_uri() . '/inc/js/scroll.shrink.js', array(), NAKED_VERSION, true );
 ...
 */
function naked_body_classes( $classes ) {
...
add_filter( 'body_class', 'naked_body_classes' );
 ...
 */
function naked_post_classes( $classes ) {
...
add_filter( 'post_class', 'naked_post_classes' );
 ...
 */
function naked_wp_title( $title, $sep ) {
	global $paged, $page;
...
add_filter( 'wp_title', 'naked_wp_title', 10, 2 );
